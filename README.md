...
5. Now you're going to run these SQL files.
   ...
   * **IMPORTANT:** Instead of using the MySQL command line tool, you may use MySQL Workbench.
...
2. In `controllers`, create the `burgersController.js` file.

3. Inside the `burgersController.js` file, import the following:
